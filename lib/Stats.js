...
class Stats {
    ...
    print() {
        ...
        let crawlRate = !this.crawled ? 0 : this.crawled / (totalMillis / 1000 / 60)
        let pushRate = !this.pushed ? 0 : this.pushed / (totalMillis / 1000 / 60)

        let scrawlRate = !this.sessionCrawled ? 0 : this.sessionCrawled / (sessionMillis / 1000 / 60) || 0
        let spushRate = !this.sessionPushed ? 0 : this.sessionPushed / (sessionMillis / 1000 / 60) || 0
    ...
    load() {
        ...
        if (fs.existsSync(fpath)) {
            ...
            //when restarting base url is forcibly loaded
            //so exlcude it from the count
            if (this.crawled > 0) {
                this.crawled--
            }
